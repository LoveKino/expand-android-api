...
public class Activity extends ContextThemeWrapper
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        /*********************hack start***********************/
        if(this.yard == null) {
            this.yard = PatchReadHookSource.doRead(this, "android.app.Activity");
        }
        this.yard.receive("onCreate:start", new Object[] {savedInstanceState});
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onCreate:end", new Object[] {savedInstanceState});
        /*********************hack end***********************/
    }
    ...
    protected void onStart() {
        /*********************hack start***********************/
        this.yard.receive("onStart:start", null);
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onStart:end", null);
        /*********************hack end***********************/
    }
    ...
    protected void onResume() {
        /*********************hack start***********************/
        this.yard.receive("onResume:start", null);
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onResume:end", null);
        /*********************hack end***********************/
    }
    ...
    protected void onPause() {
        /*********************hack start***********************/
        this.yard.receive("onPause:start", null);
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onPause:end", null);
        /*********************hack end***********************/
    }
    ...
    protected void onStop() {
        /*********************hack start***********************/
        this.yard.receive("onStop:start", null);
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onStop:end", null);
        /*********************hack end***********************/
    }
    ...
    protected void onDestroy() {
        /*********************hack start***********************/
        this.yard.receive("onDestroy:start", null);
        /*********************hack end***********************/
        ...
        /*********************hack start***********************/
        this.yard.receive("onDestroy:end", null);
        /*********************hack end***********************/
    }
