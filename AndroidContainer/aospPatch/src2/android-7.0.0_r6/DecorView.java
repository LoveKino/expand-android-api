...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    DecorView(Context context, int featureId, PhoneWindow window,
        ...
        /*********************hack start***********************/
        if(this.yard == null) {
            this.yard = PatchReadHookSource.doRead(context, "com.android.internal.policy.DecorView");
        }
        /*********************hack end***********************/
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        /*********************hack start***********************/
        this.yard.receive("dispatchTouchEvent:start", new Object[] {ev});
        /*********************hack end***********************/

        final Window.Callback cb = mWindow.getCallback();
        boolean ret = cb != null && !mWindow.isDestroyed() && mFeatureId < 0
                ? cb.dispatchTouchEvent(ev) : super.dispatchTouchEvent(ev);

        /*********************hack start***********************/
        this.yard.receive("dispatchTouchEvent:end", new Object[] {ev, ret});
        /*********************hack end***********************/
        return ret;
    }
