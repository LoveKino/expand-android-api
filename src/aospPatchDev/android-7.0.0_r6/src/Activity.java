...
/*********************hack start***********************/
import android.util.PatchReadHookSource;
/**********************hack end**********************/
...
public class Activity extends ContextThemeWrapper
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        System.out.println(PatchReadHookSource.doRead(this));
        System.out.println("----------------------------------");
        /*********************hack end***********************/
    }
    ...
    public final void requestPermissions(@NonNull String[] permissions, int requestCode) {
        if (mHasCurrentPermissionsRequest) {
            ...
            System.out.println(PatchReadHookSource.onRequestPermissionsResult(this, requestCode, new String[0], new int[0]));
            System.out.println("----------------------------------");
            /*********************hack end***********************/
            return;
        }
    ...
    private void dispatchRequestPermissionsResult(int requestCode, Intent data) {
        ...
        /*********************hack start***********************/
        System.out.println("----------------dispatchRequestPermissionsResult------------------------");
        System.out.println(PatchReadHookSource.onRequestPermissionsResult(this, requestCode, permissions, grantResults));
        System.out.println("----------------------------------");
        /*********************hack end***********************/
    }
